...
export const Footer = () => {
  ...
  return (
    <footer className={`bg-bg-secondary border-t border-border-color mt-auto ${isLandingPage ? 'py-12' : 'py-6'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`${isLandingPage ? 'pt-8 border-t border-border-color' : ''} flex flex-col md:flex-row justify-between items-center text-sm text-text-muted`}>
