...
const SCHEDULE_DATA: Record<'DAY_01' | 'DAY_02', Array<{ time: string; title: string; type: string; venue: string; bgClass: string; accent: string; image?: string; slug?: string }>> = {
  DAY_01: [
    { time: '09:00 AM', title: 'Inauguration', type: 'GENERAL', venue: 'F block assembly hall', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22', image: '/assets/gallery-1.png' },
    { time: '10:00 AM', title: 'Snacks', type: 'GENERAL', venue: 'F Block Canteen', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22' },
    { time: '10:30 AM', title: 'Code Relay', type: 'TECHNICAL', venue: 'CAT Lab', bgClass: 'from-[#1C140D] to-[#0A0607]', accent: '#F97316', image: '/assets/events/code_relay.png', slug: 'code-relay' },
    { time: '10:30 AM', title: 'Hunt your Treasure', type: 'GAMING', venue: 'K503, K504, K505', bgClass: 'from-[#0D1C16] to-[#0A0607]', accent: '#10B981', image: '/assets/events/hunt_your_treasure.png', slug: 'hunt-your-treasure' },
    { time: '12:30 PM', title: 'Lunch', type: 'GENERAL', venue: 'F block Canteen', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22' },
    { time: '01:30 PM', title: 'Pixel Paradox', type: 'CREATIVE', venue: 'IS Lab', bgClass: 'from-[#160A18] to-[#0A0607]', accent: '#A855F7', image: '/assets/events/pixel_paradox.png', slug: 'pixel-paradox' },
    { time: '01:30 PM', title: 'Project Phoenix', type: 'TECHNICAL', venue: 'CAT Lab', bgClass: 'from-[#1C140D] to-[#0A0607]', accent: '#F97316', image: '/assets/events/phoenix.png', slug: 'project-phoenix' },
    { time: '03:00 PM', title: 'In the Slot', type: 'GAMING', venue: 'F202', bgClass: 'from-[#0D1C16] to-[#0A0607]', accent: '#10B981', image: '/assets/events/in_the_slot.png', slug: 'in-the-slot' },
    { time: '03:30 PM', title: 'Blind Coding', type: 'TECHNICAL', venue: 'CC Lab', bgClass: 'from-[#1C140D] to-[#0A0607]', accent: '#F97316', image: '/assets/events/blind_coding.png', slug: 'blind-coding' },
  ],
  DAY_02: [
    { time: '09:30 AM', title: 'The Extraction', type: 'TECHNICAL', venue: 'CAT Lab', bgClass: 'from-[#1C140D] to-[#0A0607]', accent: '#F97316', image: '/assets/events/the_extraction.png', slug: 'the-extraction' },
    { time: '10:00 AM', title: 'Debug Arena', type: 'TECHNICAL', venue: 'CC Lab', bgClass: 'from-[#1C140D] to-[#0A0607]', accent: '#F97316', image: '/assets/events/debug_arena.png', slug: 'debug-arena' },
    { time: '12:30 PM', title: 'Star of Login (Round 1)', type: 'GENERAL', venue: 'F202', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22', image: '/assets/events/star_of_login.png', slug: 'star-of-login' },
    { time: '01:00 PM', title: 'Lunch', type: 'GENERAL', venue: 'F block Canteen', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22' },
    { time: '02:00 PM', title: 'Star of Login (Round 2)', type: 'GENERAL', venue: 'D block conference hall (Ground floor)', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22', image: '/assets/events/star_of_login.png', slug: 'star-of-login' },
    { time: '03:30 PM', title: 'Valedictory', type: 'GENERAL', venue: 'D block conference hall (Ground floor)', bgClass: 'from-[#1A0B0E] to-[#0A0607]', accent: '#E01B22', image: '/assets/gallery-2.png' },
    { time: '05:00 PM', title: 'Entertainment', type: 'GAMING', venue: 'Centenary hall', bgClass: 'from-[#0D1C16] to-[#0A0607]', accent: '#10B981', image: '/assets/events/nostos.png', slug: 'nostos' },
